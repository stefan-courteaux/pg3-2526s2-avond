...
namespace ShipIt.IdentityServer.Pages.Logout;
...
public class Index : PageModel
{
    ...
    public Index(SignInManager<ShipItUser> signInManager, IIdentityServerInteractionService interaction, IEventService events)
    {
